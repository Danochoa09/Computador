...
; Salida: R4 = MCD(a, b)
; Modifica: R4, R5, R6
; IMPORTANTE: Llamar con LLAMA mcd_start
mcd_start:
...
; Salida: R4 = n!
; Modifica: R4, R5, R6
; IMPORTANTE: Llamar con LLAMA factorial_start
factorial_start:
    ; Guardar n
...
; Se colocan al final para que el código ejecutable empiece en la posición 0
math_temp_a:
.data 0
math_temp_b:
.data 0
